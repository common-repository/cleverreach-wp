...
* Easily create and send emails with our user-friendly newsletter or classic editor
...
= About CleverReach® =
CleverReach® is one of the leading providers for email marketing and impresses more than 300,000 customers in 170 countries with the effectiveness and simplicity of the software. Founded in 2007, CleverReach® always valued the importance of data protection standards, always exceeding legal requirements.
...
5. Insert your content in a free email template via drag & drop with just one click
...
- Add compatibility for system versions after 5.8

#### 1.5.19 - January 16, 2023

**Updates**

- Fix deleting completed tasks

#### 1.5.18 - November 29, 2022

**Updates**

- Fix authorization for Google Chrome 107.0.5304.87

#### 1.5.17 - August 8, 2022

**Updates**

- Add disconnection of integration upon group deleted on CleverReach dashboard.

#### 1.5.16 - July 19, 2022

**Updates**

- Added single sing-on link on the new banner in plugin dashboard page.
